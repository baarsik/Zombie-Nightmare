...
// Settings
#define WEAPON_KEY 503 // WeaponKey
#define WEAPON_OLD "weapon_sg550" // Old weapon
//#define customShell

// Animation
#define IDLE_ANIM 0
#define IDLE_SPEED 5.03
#define SHOOT_ANIM 1, 2
#define SHOOT_SPEED 1.03
#define RELOAD_ANIM 3
#define RELOAD_SPEED 3.03
#define DRAW_ANIM 4
#define DRAW_SPEED 1.53

// Resources
#define WEAPON_MODEL_V "models/zn/weapons/v_bendita.mdl"
#define WEAPON_MODEL_P "models/zn/weapons/p_bendita.mdl"
#define WEAPON_MODEL_W "models/zn/weapons/w_bendita.mdl"
#define WEAPON_MODEL_S "models/zn/weapons/rshell.mdl"
#define WEAPON_SOUND_S "weapons/bendita-1.wav"
...
public plugin_natives () {
	register_native("zn_give_bendita", "give_wpn", 1)
}
...
public plugin_init() {
	...
	cvar_clip = register_cvar("zn_wpn_bendita_clip", "20")
	cvar_ammo = register_cvar("zn_wpn_bendita_ammo", "135")
	cvar_rate = register_cvar("zn_wpn_bendita_rate", "0.215")
	cvar_damage = register_cvar("zn_wpn_bendita_damage", "1.05")
	cvar_return_left = register_cvar("zn_wpn_bendita_return_left", "-2.0")
	cvar_return_right = register_cvar("zn_wpn_bendita_return_right", "2.0")
	cvar_return_up = register_cvar("zn_wpn_bendita_return_up", "1.0")
	cvar_return_down = register_cvar("zn_wpn_bendita_return_down", "-1.0")
	cvar_return_multi = register_cvar("zn_wpn_bendita_return_multi", "0.25")
	RegisterHam(Ham_Spawn, "weaponbox", "fw_Spawn_Weaponbox_Post", 1);
	register_forward(FM_UpdateClientData, "fw_UpdateClientData_Post", 1);
	register_forward(FM_PlaybackEvent, "fw_PlaybackEvent");
	register_forward(FM_SetModel, "fw_SetModel");
	state WeaponBox_Disabled;
	g_item = zp_register_extra_item("bendita", 10, ZP_TEAM_HUMAN);
}
public plugin_precache() {
	...
	engfunc(EngFunc_PrecacheSound, "weapons/as50_clipin1.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/as50_clipin2.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/as50_clipout1.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/as50_clipout2.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/as50_draw.wav");
