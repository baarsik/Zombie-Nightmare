...
// Settings
#define WEAPON_KEY 404 // WeaponKey
#define WEAPON_OLD "weapon_galil" // Old weapon
//#define customShell

// Animation
#define IDLE_ANIM 0
#define IDLE_SPEED 1.55
#define SHOOT_ANIM 3, 3
#define SHOOT_SPEED 1.03
#define RELOAD_ANIM 1
#define RELOAD_SPEED 3.025
#define DRAW_ANIM 2
#define DRAW_SPEED 1.53

// Resources
#define WEAPON_MODEL_V "models/zn/weapons/v_m14ebr.mdl"
#define WEAPON_MODEL_P "models/zn/weapons/p_m14ebr.mdl"
#define WEAPON_MODEL_W "models/zn/weapons/w_m14ebr.mdl"
#define WEAPON_MODEL_S "models/zn/weapons/rshell.mdl"
#define WEAPON_SOUND_S "weapons/m14ebr-1.wav"
...
public plugin_natives () {
    register_native("zn_give_m14ebr", "give_wpn", 1)
}
...
public plugin_init() {	
	...
	cvar_clip = register_cvar("zn_wpn_m14ebr_clip", "20")
	cvar_ammo = register_cvar("zn_wpn_m14ebr_ammo", "135")
	cvar_rate = register_cvar("zn_wpn_m14ebr_rate", "0.125")
	cvar_damage = register_cvar("zn_wpn_m14ebr_damage", "1.35")
	cvar_return_left = register_cvar("zn_wpn_m14ebr_return_left", "2.0")
	cvar_return_right = register_cvar("zn_wpn_m14ebr_return_right", "1.5")
	cvar_return_up = register_cvar("zn_wpn_m14ebr_return_up", "1.8")
	cvar_return_down = register_cvar("zn_wpn_m14ebr_return_down", "-1.8")
	cvar_return_multi = register_cvar("zn_wpn_m14ebr_return_multi", "0.25")
	RegisterHam(Ham_Spawn, "weaponbox", "fw_Spawn_Weaponbox_Post", 1);
	register_forward(FM_UpdateClientData, "fw_UpdateClientData_Post", 1);
	register_forward(FM_PlaybackEvent, "fw_PlaybackEvent");
	register_forward(FM_SetModel, "fw_SetModel");
	state WeaponBox_Disabled;
	g_item = zp_register_extra_item("m14", 10, ZP_TEAM_HUMAN);
}
public plugin_precache() {
	...
	engfunc(EngFunc_PrecacheSound, "weapons/m14_clipin.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/m14_clipout.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/m14_draw.wav");
