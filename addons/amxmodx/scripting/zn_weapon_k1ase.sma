...
// Settings
#define WEAPON_KEY 303 // WeaponKey
#define WEAPON_OLD "weapon_mp5navy" // Old weapon
//#define customShell
...
#define SHOOT_SPEED 0.52
#define RELOAD_ANIM 1
#define RELOAD_SPEED 3.0
#define DRAW_ANIM 2
#define DRAW_SPEED 1.140

// Resources
#define WEAPON_MODEL_V "models/zn/weapons/v_k1ase.mdl"
#define WEAPON_MODEL_P "models/zn/weapons/p_k1ase.mdl"
#define WEAPON_MODEL_W "models/zn/weapons/w_k1ase.mdl"
#define WEAPON_MODEL_S "models/zn/weapons/rshell.mdl"
#define WEAPON_SOUND_S "weapons/k1ase.wav"
...
public plugin_natives () {
	register_native("zn_give_k1ase", "give_wpn", 1)
}
...
public plugin_init() {
	...
	cvar_clip = register_cvar("zn_wpn_k1ase_clip", "30")
	cvar_ammo = register_cvar("zn_wpn_k1ase_ammo", "180")
	cvar_rate = register_cvar("zn_wpn_k1ase_rate", "0.09")
	cvar_damage = register_cvar("zn_wpn_k1ase_damage", "1.0")
	cvar_return_left = register_cvar("zn_wpn_k1ase_return_left", "2.0")
	cvar_return_right = register_cvar("zn_wpn_k1ase_return_right", "2.0")
	cvar_return_up = register_cvar("zn_wpn_k1ase_return_up", "1.5")
	cvar_return_down = register_cvar("zn_wpn_k1ase_return_down", "-1.5")
	cvar_return_multi = register_cvar("zn_wpn_k1ase_return_multi", "0.25")
	RegisterHam(Ham_Spawn, "weaponbox", "fw_Spawn_Weaponbox_Post", 1);
	register_forward(FM_UpdateClientData, "fw_UpdateClientData_Post", 1);
	register_forward(FM_PlaybackEvent, "fw_PlaybackEvent");
	register_forward(FM_SetModel, "fw_SetModel");
	state WeaponBox_Disabled;
	g_item = zp_register_extra_item("k1ase", 10, ZP_TEAM_HUMAN);
}
public plugin_precache() {
	...
	engfunc(EngFunc_PrecacheSound, "weapons/k1a_clipin.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/k1a_clipout.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/k1a_draw.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/k1a_foley1.wav");
