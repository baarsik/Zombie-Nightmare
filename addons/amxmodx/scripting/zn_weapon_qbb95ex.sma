...
new cvar_clip, cvar_ammo, cvar_rate, cvar_damage, cvar_return_left, cvar_return_right, cvar_return_up,
	cvar_return_down, cvar_return_multi;
...
// Settings
#define WEAPON_KEY 602 // WeaponKey
#define WEAPON_OLD "weapon_m249" // Old weapon
//#define customShell

// Animation
#define IDLE_ANIM 0
#define IDLE_SPEED 0.125
#define SHOOT_ANIM 3, 5
#define SHOOT_SPEED 0.64
#define RELOAD_ANIM 1
#define RELOAD_SPEED 3.8
#define DRAW_ANIM 2
#define DRAW_SPEED 1.0

// Resources
#define WEAPON_MODEL_V "models/zn/weapons/v_qbb95ex.mdl"
#define WEAPON_MODEL_P "models/zn/weapons/p_qbb95ex.mdl"
#define WEAPON_MODEL_W "models/zn/weapons/w_qbb95ex.mdl"
#define WEAPON_MODEL_S "models/zn/weapons/rshell.mdl"
#define WEAPON_SOUND_S "weapons/qbb95.wav"
...
public plugin_natives () {
	register_native("zn_give_qbb95ex", "give_wpn", 1)
}
...
public plugin_init() {
	...
	cvar_clip = register_cvar("zn_wpn_qbb95ex_clip", "75")
	cvar_ammo = register_cvar("zn_wpn_qbb95ex_ammo", "200")
	cvar_rate = register_cvar("zn_wpn_qbb95ex_rate", "0.13")
	cvar_damage = register_cvar("zn_wpn_qbb95ex_damage", "1.05")
	cvar_return_left = register_cvar("zn_wpn_qbb95ex_return_left", "1.1")
	cvar_return_right = register_cvar("zn_wpn_qbb95ex_return_right", "1.1")
	cvar_return_up = register_cvar("zn_wpn_qbb95ex_return_up", "1.0")
	cvar_return_down = register_cvar("zn_wpn_qbb95ex_return_down", "-1.0")
	cvar_return_multi = register_cvar("zn_wpn_qbb95ex_return_multi", "0.25")
	RegisterHam(Ham_Spawn, "weaponbox", "fw_Spawn_Weaponbox_Post", 1);
	register_forward(FM_UpdateClientData, "fw_UpdateClientData_Post", 1);
	register_forward(FM_PlaybackEvent, "fw_PlaybackEvent");
	register_forward(FM_SetModel, "fw_SetModel");
	state WeaponBox_Disabled;
	g_item = zp_register_extra_item("qbb95ex", 10, ZP_TEAM_HUMAN);
}
public plugin_precache() {
	...
	engfunc(EngFunc_PrecacheSound, "weapons/qbb95_clipin.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/qbb95_clipon.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/qbb95_clipout.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/qbb95_draw.wav");
