...
// Settings
#define WEAPON_KEY 603 // WeaponKey
#define WEAPON_OLD "weapon_m249" // Old weapon
//#define customShell

// Animation
#define IDLE_ANIM 0
#define IDLE_SPEED 3.81
#define SHOOT_ANIM 1, 2
#define SHOOT_SPEED 0.73
#define RELOAD_ANIM 3
#define RELOAD_SPEED 4.03
#define DRAW_ANIM 4
#define DRAW_SPEED 1.03

// Resources
#define WEAPON_MODEL_V "models/zn/weapons/v_m60e4.mdl"
#define WEAPON_MODEL_P "models/zn/weapons/p_m60e4.mdl"
#define WEAPON_MODEL_W "models/zn/weapons/w_m60e4.mdl"
#define WEAPON_MODEL_S "models/zn/weapons/rshell.mdl"
#define WEAPON_SOUND_S "weapons/m60e4.wav"
...
public plugin_natives () {
	register_native("zn_give_m60e4", "give_wpn", 1)
}
...
public plugin_init() {
	...
	cvar_clip = register_cvar("zn_wpn_m60e4_clip", "100")
	cvar_ammo = register_cvar("zn_wpn_m60e4_ammo", "200")
	cvar_rate = register_cvar("zn_wpn_m60e4_rate", "0.13")
	cvar_damage = register_cvar("zn_wpn_m60e4_damage", "1.0")
	cvar_return_left = register_cvar("zn_wpn_m60e4_return_left", "1.0")
	cvar_return_right = register_cvar("zn_wpn_m60e4_return_right", "1.0")
	cvar_return_up = register_cvar("zn_wpn_m60e4_return_up", "1.0")
	cvar_return_down = register_cvar("zn_wpn_m60e4_return_down", "-1.0")
	cvar_return_multi = register_cvar("zn_wpn_m60e4_return_multi", "0.25")
	RegisterHam(Ham_Spawn, "weaponbox", "fw_Spawn_Weaponbox_Post", 1);
	register_forward(FM_UpdateClientData, "fw_UpdateClientData_Post", 1);
	register_forward(FM_PlaybackEvent, "fw_PlaybackEvent");
	register_forward(FM_SetModel, "fw_SetModel");
	state WeaponBox_Disabled;
	g_item = zp_register_extra_item("m60e4", 10, ZP_TEAM_HUMAN);
}
public plugin_precache() {
	...
	engfunc(EngFunc_PrecacheSound, "weapons/m60e4_clipin1.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/m60e4_clipin1.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/m60e4_clipin1.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/m60e4_clipin1.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/m60e4_clipout1.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/m60e4_clipout2.wav");
