...
// Settings
#define WEAPON_KEY 301 // WeaponKey
#define WEAPON_OLD "weapon_tmp" // Old weapon
//#define customShell

// Animation
#define IDLE_ANIM 0
#define IDLE_SPEED 1.7
#define SHOOT_ANIM 3, 4
#define SHOOT_SPEED 1.03
#define RELOAD_ANIM 1
#define RELOAD_SPEED 3.7
#define DRAW_ANIM 2
#define DRAW_SPEED 1.53

// Resources
#define WEAPON_MODEL_V "models/zn/weapons/v_mp7h.mdl"
#define WEAPON_MODEL_P "models/zn/weapons/p_mp7h.mdl"
#define WEAPON_MODEL_W "models/zn/weapons/w_mp7h.mdl"
#define WEAPON_MODEL_S "models/zn/weapons/rshell.mdl"
#define WEAPON_SOUND_S "weapons/mp7.wav"
...
public plugin_natives () {
	register_native("zn_give_mp7h", "give_wpn", 1)
}
...
public plugin_init() {
	...
	cvar_clip = register_cvar("zn_wpn_mp7h_clip", "30")
	cvar_ammo = register_cvar("zn_wpn_mp7h_ammo", "135")
	cvar_rate = register_cvar("zn_wpn_mp7h_rate", "0.09")
	cvar_damage = register_cvar("zn_wpn_mp7h_damage", "1.0")
	cvar_return_left = register_cvar("zn_wpn_mp7h_return_left", "1.2")
	cvar_return_right = register_cvar("zn_wpn_mp7h_return_right", "1.7")
	cvar_return_up = register_cvar("zn_wpn_mp7h_return_up", "0.25")
	cvar_return_down = register_cvar("zn_wpn_mp7h_return_down", "-0.25")
	cvar_return_multi = register_cvar("zn_wpn_mp7h_return_multi", "0.25")
	RegisterHam(Ham_Spawn, "weaponbox", "fw_Spawn_Weaponbox_Post", 1);
	register_forward(FM_UpdateClientData, "fw_UpdateClientData_Post", 1);
	register_forward(FM_PlaybackEvent, "fw_PlaybackEvent");
	register_forward(FM_SetModel, "fw_SetModel");
	state WeaponBox_Disabled;
	g_item = zp_register_extra_item("mp7h", 10, ZP_TEAM_HUMAN);
}
public plugin_precache() {
	...
	engfunc(EngFunc_PrecacheSound, "weapons/horsegun_boltpull.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/horsegun_clipin.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/horsegun_clipout.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/horsegun_draw.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/horsegun_idle.wav");
