...
new cvar_clip, cvar_ammo, cvar_rate, cvar_damage, cvar_return_left, cvar_return_right,
	cvar_return_up, cvar_return_down, cvar_return_multi;
...
// Settings
#define WEAPON_KEY 203 // WeaponKey
#define WEAPON_OLD "weapon_xm1014" // Old weapon
//#define customShell

// Animation
#define IDLE_ANIM 0
#define IDLE_SPEED 1.7
#define SHOOT_ANIM 1, 2
#define SHOOT_SPEED 1.03
#define RELOAD_ANIM 3, 4
#define RELOAD_SPEED 3.03
#define DRAW_ANIM 5
#define DRAW_SPEED 1.13

// Resources
#define WEAPON_MODEL_V "models/zn/weapons/v_spas12m.mdl"
#define WEAPON_MODEL_P "models/zn/weapons/p_spas12m.mdl"
#define WEAPON_MODEL_W "models/zn/weapons/w_spas12m.mdl"
#define WEAPON_MODEL_S "models/zn/weapons/rshell.mdl"
#define WEAPON_SOUND_S "weapons/spas12excraft-1.wav"
...
public plugin_natives () {
	register_native("zn_give_spas12m", "give_wpn", 1)
}
...
public plugin_init() {
	...
	cvar_clip = register_cvar("zn_wpn_spas12m_clip", "8")
	cvar_ammo = register_cvar("zn_wpn_spas12m_ammo", "48")
	cvar_rate = register_cvar("zn_wpn_spas12m_rate", "0.33")
	cvar_damage = register_cvar("zn_wpn_spas12m_damage", "1.2")
	cvar_return_left = register_cvar("zn_wpn_spas12m_return_left", "1.0")
	cvar_return_right = register_cvar("zn_wpn_spas12m_return_right", "2.0")
	cvar_return_up = register_cvar("zn_wpn_spas12m_return_up", "1.0")
	cvar_return_down = register_cvar("zn_wpn_spas12m_return_down", "-1.0")
	cvar_return_multi = register_cvar("zn_wpn_spas12m_return_multi", "0.25")
	RegisterHam(Ham_Spawn, "weaponbox", "fw_Spawn_Weaponbox_Post", 1);
	register_forward(FM_UpdateClientData, "fw_UpdateClientData_Post", 1);
	register_forward(FM_PlaybackEvent, "fw_PlaybackEvent");
	register_forward(FM_SetModel, "fw_SetModel");
	state WeaponBox_Disabled;
	g_item = zp_register_extra_item("spas12m", 10, ZP_TEAM_HUMAN);
}
public plugin_precache() {
	...
	engfunc(EngFunc_PrecacheSound, "weapons/spas12excraft_boltpull.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/spas12excraft_clipin.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/spas12excraft_clipout.wav");
	engfunc(EngFunc_PrecacheSound, "weapons/spas12excraft_draw.wav");
...
public fw_Weapon_PrimaryAttack(ent) {
	...
	Punchangle[0] -= random_float((get_pcvar_float(cvar_return_left)), (get_pcvar_float(cvar_return_right))) + Punchangle[0] * get_pcvar_float(cvar_return_multi); // No random for shotgun
...
public fw_Weapon_Reload(ent) {
	...
	UTIL_SendWeaponAnim(id, random_num(RELOAD_ANIM));
